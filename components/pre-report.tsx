...
const PreReport = () => {
  return (
    <div className="w-[210mm] max-h-[297mm] bg-white px-[48px] pt-[72px]">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <p className="mb-4 text-xs">
            ...
            body&apos;s health. The diversity, richness and composition of the
            microbiome is essential for a healthy gut and also in maintaining a
            healthy state in the whole body. The gut microbiome community
            depends mainly on lifestyle and environmental factors. A long-termed
            absence or imbalanced quantity of certain bacteria can lead to
            different health problems like obesity, digestion problems and
            autoimmune diseases.
          </p>
        ...
        <div>
          ...
          <h2 className="text-xs font-bold">Summary of the report</h2>
      ...
      <div className="text-[6px] mb-[13px]">
        <p className="mb-2">
      ...
      <div className="flex justify-between items-center text-[7px] mt-[13px] text-gray-600">
