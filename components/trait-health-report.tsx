...
export function TraitHealthReportComponent({
  ...
  return (
    <div className="bg-white px-[48px] pt-[96px]">
      ...
      <h1 className="text-xl font-bold mb-4 leading-[16.8px] tracking-wide ">
        Dear {personal_info.name},
      </h1>

      <p className="text-md mb-[60px] tracking-wide opacity-50">
      ...
      <h2 className="h-10 text-black text-2xl font-semibold font-['Montserrat'] mb-10">
        About your raw data
      </h2>

      <div className="text-md  mb-[200px]">
        <div className="grid grid-cols-1 gap-2">
          ...
          <div className="flex justify-between">
            ...
            <span>
              <strong>{personal_info.gender}</strong>
            </span>
          </div>
          <hr className="my-1" />
          ...
          <div className="flex justify-between">
            ...
            <span>
              <strong>{personal_info.report_date}</strong>
            </span>
          </div>
          <hr className="my-1" />
        </div>
